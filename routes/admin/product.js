...
router.route("/product").post(protect, createProduct).get(protect, getProducts);
router.route("/product/:id").get(protect, singleProduct).post(protect, editProduct).delete(protect, removeProduct);
router.route("/productSale/:id").post(protect, saveProductSale)
router.route("/productSub/:id").get(protect, getSingleSub);
router.route("/productAngilal/:id").post(protect, getProductById);
